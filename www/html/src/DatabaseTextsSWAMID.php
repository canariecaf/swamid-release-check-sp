...
_('schacPersonalUniqueCode starting with urn:schac:personalUniqueCode:int:esi:se:');
...
_('Identity Provider is not approved for any SWAMID Identity Assurance Profiles but sends Assurance information!.');
#IdPCheckSWAMID.php:193: testResult
_('Assurance Profile missing. Sends Assurance information!');
#IdPCheckSWAMID.php:195: #status_ERROR
_('Identity Provider is not approved for any SWAMID Identity Assurance Profiles.');
#IdPCheckSWAMID.php:196: testResult
_('Assurance Profile missing.');
...
_('Have Assurance Profile. Sends invalid Assurance information.');
#IdPCheckSWAMID.php:238: #status_ERROR
_('Missing Assurance information. Expected at least [[SWAMID_ASSURANCE]]/al1');
#IdPCheckSWAMID.php:239: testResult
_('Have Assurance Profile. Missing [[SWAMID_ASSURANCE]]/al1 for user.');
#IdPCheckSWAMID.php:243: testResult
_('Have Assurance Profile. Missing some Assurance information.');
