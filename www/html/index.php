...
if ($html->shouldRenderTab('esi')) {
  printf('    
      ...
      $esiShow, $esiActive, $federation['displayName'], $config->basename(), _('Run tests'), $result ? HTML_SHIBBOLETH_LOGIN . $idp : '',
      "\n");
  if (! $result ) {
    printf('        <div class="col">
